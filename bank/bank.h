...
typedef struct _Bank {
    ...
    HashTable *ht; // Tejan(anteater): Added thhe hashtable to store users and their info. 
    unsigned char* AuthToken; // Tejan(anteater): handling the token 
    char *name; 
    long long users; 
    HashTable *hashToName;
    // Protocol state
    // TODO add more, as needed
    /**
        Added a new field in struct:  
